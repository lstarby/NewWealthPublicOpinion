...
- (void)createView
{
    ...
    pageNumberLabel = [[UILabel alloc] initWithFrame:CGRectMake(frameRect.size.width/2 - 40, frameRect.size.height - 50, 85, 40)];
    ...
    [pageNumberLabel setFont:[UIFont systemFontOfSize:22]];
    int currentPage = 1;
