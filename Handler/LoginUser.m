...
- (void)encodeWithCoder:(NSCoder *)aCoder {
    ...
    [aCoder encodeObject:self.isPushInformation forKey:@"isPushInformation"];
    [aCoder encodeObject:self.isPushReport forKey:@"isPushReport"];
    [aCoder encodeObject:self.isPushWarning forKey:@"isPushWarning"];
...
- (id)initWithCoder:(NSCoder *)aDecoder {
    if (self = [super init]) {
        ...
        self.isPushInformation = [aDecoder decodeObjectForKey:@"isPushInformation"];
        self.isPushReport      = [aDecoder decodeObjectForKey:@"isPushReport"];
        self.isPushWarning     = [aDecoder decodeObjectForKey:@"isPushWarning"];
